<template>
  <div style="height: 100%; position: relative; background:#f0f2f5;margin-top: -20px;">
    <div class="wscn-http404">
      ...
      <div class="bullshit">
        <div class="bullshit__oops">Huixianfeng</div>
...
<style type="text/css"  lang="stylus" scoped>
	@media(max-width:900px ) {
		...
		.wscn-http404 .bullshit{
			...
			.wscn-http404 .bullshit__return-home[data-v-d989eb38]{
				float: none;
				margin: 0 auto;
			}
