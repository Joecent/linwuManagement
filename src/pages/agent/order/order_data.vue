<template>
   ...
   <div class="shop_title">
      <div class="shop_info">
        <!-- <div class="shop_image"><img src="@/assets/images/shop.png"></div> -->
        <div class="shop_name" v-if="ispay==1">初级合伙人</div>
        <div class="shop_name" v-if="ispay==0">暂未加入</div>
      </div>
...
<script type="text/javascript">
	import {day_order,count_order,day_money,mon_money,money,order_num,week_order,new_people,week_people,show_forum,shop_info,sumpeople} from '@/utils/api'
      ...
      order_num(){
        order_num({shop_id:store.get('currentshopid')}).then((res)=>{
          ...
          this.refund_num=res.data.refund[0].order_num
			...
			get_money(){
				this.$router.push('/agent/shopinfo')
			},
			day_order(){
