...
<div class="orders">
    ...
    <el-dialog title="填写发货信息" :visible.sync="tosend" label-width="80px" style="width:100%;margin-top:100px">
...
import {admin_wait,send,admin_waits,admin_all_wait} from '@/utils/api' 
	export default{
		...
		admin_wait(){
			admin_waits({shop_id:store.get('currentshopid'),page:this.currentPage,order_type:0}).then((res)=>{
				var order_goods=[]
