	...
	<div class="l-container modify_page">
		<el-tabs v-model="activeName">
			...
			<el-tab-pane label="店铺信息" name="first">
				...
				<div class="l-content-box">
					<div class="l-renovation-box-title">店铺logo：<br />
						<div class="l-cc">建议尺寸160px*160px</div>
					</div>
					<div class="l-renovation-box-content">
						<el-form :model="form">
							<el-form-item>
								<el-upload action="https://www.linwushop.com/api/upload_img" :on-success='uploadsuccess' :before-upload="logoUploadif" :on-remove="remove_logo" :limit='1'>
									<div class="shop_photo">
										<img class="l-modify-logo" :src="form.LogoimageUrl" />
										<a>重新上传</a>
									</div>
								</el-upload>
							</el-form-item>
				 ...
				 <div class="l-content-box" v-if='shop_type==2'>
			...
			<el-tab-pane label="店铺设置" name="third">
				...
				<div class="setting">
					<!-- <div class="l-content-box">
						<div class="l-renovation-box-title">是否开启店铺信息：</div>
						<div class="l-renovation-box-content">
							<el-switch v-model="form2.shop_info_isshow" active-color="#13ce66" inactive-color="#ff4949"></el-switch>
						</div>
					</div> -->
					...
					<div class="l-content-box">
						...
						<div class="l-renovation-box-content">
							<el-input type="text" class="l-input" v-model="form2.business_hours" placeholder="请输入店铺营业时间（如：9：00-22：00）" />
						</div>
					</div>
					<div class="l-content-box">
    ...
    card_numbers() {
      show_admin_shop_info({
        ...
        if (res.status == 1) {
          ...
          //营业时间
          this.form2.business_hours = res.data.business_hours;
          //客服电话
    ...
    complete2(file) {
      ...
      if (this.inputEmptys == false) {
        ...
        const params = {
          ...
          business_hours: this.form2.business_hours, // 营业时间
