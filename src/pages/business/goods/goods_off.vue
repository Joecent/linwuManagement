		...
		<div v-for="(item,index) in goodsinfo" class="goods_info">
			...
			<div class="nameinfo">
				...
				<div class="prices">
					...
					<div class="market_price"><span>￥{{item.market_price[0]}}</span></span></div>
				</div>
...
import {sel_cate,goods_del,search_goods,show_no_sale,set_on_sale,goods_delete} from '@/utils/api'
	export default{
		data(){
			return{
				pagecount:1,
		...
		methods:{
			...
			showaddgoodsmethod(){
				this.$router.push('/business/goods/goods_edit')
			},
